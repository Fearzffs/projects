...
| [`12-showcase-demo`](12-showcase-demo) | Telemetry showcase gluing `01`–`11` (real host metrics) |
...
Backlog: [`docs/BACKLOG.md`](docs/BACKLOG.md) (spine complete through `12-showcase-demo`).
